...
const TrippyScroll = () => {
  ...
  return (
    <div ref={targetRef} className="relative z-0 h-[800vh] bg-white-200">
      <div className="sticky top-0 h-screen bg-purple">
...
const generateSections = (count, color, rotate) => {
  ...
  const nextColor = color === "purple" ? "white" : "purple";
...
const Trippy = ({ rotate }) => {
  return (
    <motion.div className="absolute inset-0 overflow-hidden bg-black smooth-scroll">
      {generateSections(0, "white", rotate)}
    </motion.div>
  );
};
