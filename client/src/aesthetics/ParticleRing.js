...
const ParticleRing = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="  bottom-0 leading-5 h-full w-full overflow-hidden sm:block hidden">
      <div className="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl">
        <div className="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
          <div className="self-start hidden lg:flex flex-col  mb-20">
            <h1 className="my-3 font-semibold text-purple-700 text-5xl bg-orange-100 bg-blend-normal	opacity-90 ">Welcome back.</h1>
            <p className="pr-3 text-md text-black opacity-80">
            Reignite your passion for cooking with Recipe Alchemy!
            Lets dive to a world where creativity meets culinary expertise.
            Transform ordinary ingredients into extraordinary recipes together. 
            </p>
          </div>
        </div>
      ...
      <div className="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl">
        <div className="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
          <div className="self-start  lg:flex flex-col  self-center">
            <h1 className="my-3 font-semibold text-purple-700 text-5xl bg-orange-100 bg-blend-normal opacity-90 ">Welcome back.</h1>
          </div>
        </div>
        <div className="flex justify-center self-center z-10 ">
  ...
  return (
    <group ref={ref}>
      {pointsInner.map((point) => (
        <Point key={point.idx} position={point.position} color="purple" />
      ))}
