...
const COUNTDOWN_FROM = "05/05/2024";
...
const CountDown = () => {
  ...
  return (
    <div className="p-4 bg-gradient-to-br from-purple-700 to-purple-900">
      <div className="items-center text-center text-2xl mb-1 font-bold text-white">
        Launching In
      </div>
